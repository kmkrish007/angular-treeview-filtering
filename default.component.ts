...
public checkNodes = [];
   // Hierarchical data source for TreeView component
    ...
    public field:Object = { 
      dataSource: this.localData, id: 'id', parentID: 'pid', text: 'name', hasChildren: 'hasChild', expanded: "expanded" 
    }
 ...
 searchNodes(args) {
  ...
  if (_text == "") {
    ...
    for (var j = 0; j < filteredList.length; j++) {
      ...
      var filters = this.getFilterItems(filteredList[j], this.localData);
